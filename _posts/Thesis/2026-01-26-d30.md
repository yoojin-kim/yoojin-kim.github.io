...
Python: 3.39% 포인트 차이
Java: 4.45% 포인트 차이
두 언어 모두에서 Mamba가 명확한 우위

2. Loss 값 분석

Mamba의 loss가 BiGS보다 현저히 낮음 (Python: 0.913 vs 1.152)
더 나은 수렴(convergence)을 보여줌

3. 언어별 성능

두 모델 모두 Python에서 더 좋은 성능
Java가 더 어려운 task임을 시사
...
2. **결과 테이블 작성**
```
| Task | Language | Mamba | BiGS | CodeGPT* | Δ |
   |------|----------|-------|------|----------|---|
